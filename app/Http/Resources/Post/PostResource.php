...
class PostResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'postable_type' => $this->postable_type != 'App\Models\SecretMessage' ? 'post' : 'secret_message',
            'postable' => $this->postable_type != 'App\Models\SecretMessage' ? new PostableResource($this->postable) : new SecretMessageResource($this->postable()->withTrashed()->first()),
            ...
            'retweeted' => $this->retweet()->count() ? true : false,
        ];
    }
}
