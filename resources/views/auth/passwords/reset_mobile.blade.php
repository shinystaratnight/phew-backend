                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="center half-width">
                            ...
                            <form action="{{ route('password.resetToNewMobile') }}" method="POST">
                                {{ csrf_field() }}
                                <div class="form-block white-bg rounded colored login-block">
                                    <div class="form-group inpt-required">
                                        <input type="text" name="mobile" value="{{ request()->mobile??old('mobile') }}" class="form-control blue-bg" placeholder="{!! trans('dash.auth.mobile') !!}">
                                    </div>
                                    <div class="form-group inpt-required">
                                        <input type="text" name="code" value="{{ old('code') }}" class="form-control blue-bg" placeholder="{!! trans('dash.auth.code') !!}">
                                    </div>
                                    <div class="form-group inpt-required">
