        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <div class="text-center mb-3">
                    ...
                    <h5 class="mb-0">{{ trans('dash.auth.passwords.password_recovery') }}</h5>
                    <span class="d-block text-muted">{{ trans('dash.auth.passwords.we_will_send_you_instructions_in_email') }}</span>
                </div>
