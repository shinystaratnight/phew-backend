...
@section('custom_scripts')
    ...
    @include('dashboard.nationality.custom_charts')
    <script>
...
@section('page_title')
{{ trans('dash.nationality.nationality_data') }}
@endsection
@section('sidebar_title')
    <a href="{{ route('dashboard.nationality.index') }}" class="breadcrumb-item">{{ trans('dash.nationality.nationalities') }}</a>
    <span class="breadcrumb-item active">{{ trans('dash.nationality.show_nationality') }}</span>
@endsection
@section('content')
    <div class="profile-cover">
        ...
        <div class="media align-items-center text-center text-md-left flex-column flex-md-row m-0">
            <div class="mr-md-3 mb-2 mb-md-0">
                <a href="{{ $nationality->flag_url }}" class="profile-thumb" data-popup="lightbox">
                    <img src="{{ $nationality->flag_url }}" class="bg-white border-white rounded-circle" width="48" height="48" alt="">
                </a>
            </div>
            <div class="media-body text-white">
                <h1 class="mb-0">{{ $nationality->name }}</h1>
            </div>
            <div class="ml-md-3 mt-2 mt-md-0">
                <ul class="list-inline list-inline-condensed mb-0">
                    <li class="list-inline-item"><a href="{{ route('dashboard.nationality.edit', $nationality->id) }}" class="btn btn-primary border-transparent"><i class="icon-pencil7 mr-2"></i>{{ trans('dash.actions.edit') }}</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="d-flex align-items-start flex-column flex-md-row">
            <div class="tab-content w-100 order-2 order-md-1">
                <div class="tab-pane fade active show" id="data">
                    <div class="card">
                        <div class="card-header header-elements-inline">
                            <h5 class="card-title">{{ trans('dash.nationality.show_nationality') }}</h5>
                        </div>
                        <div class="card-body">
                            <form>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3">{{ trans('dash.nationality.name') }} :</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" value="{{ $nationality->name }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3">{{ trans('dash.nationality.short_name') }} :</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" value="{{ $nationality->short_name }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3">{{ trans('dash.nationality.currency') }} :</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" value="{{ $nationality->currency  }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3">{{ trans('dash.nationality.show_phonecode') }} :</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" value="{{ $nationality->show_phonecode }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3">{{ trans('dash.nationality.continent') }} :</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" value="{{ $nationality->continent  }}" readonly>
                ...
                <div class="tab-pane fade" id="statistics">
                     <div class="card">
                        <div class="card-header header-elements-inline">
                            <h5 class="card-title">  {{ trans('dash.nationality.statistics') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-4">
