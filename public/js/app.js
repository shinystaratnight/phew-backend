...
window.Echo["private"]('phew-notification.' + window.Laravel.user.id).notification(function (notification) {
...
window.Echo.join('online').here(function (users) {
  ...
  console.log(user);
}).leaving(function (user) {// a user has left.
});
...
__webpack_require__(/*! /home/orabirmalcom/public_html/phew/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/orabirmalcom/public_html/phew/resources/sass/app.scss */"./resources/sass/app.scss");
