...
var Dashboard = function () {
    ...
    return {
        ...
        initCharts: function() {
            ...
            _chartSparkline('#models-count', 'area', 30, 50, 'basis', 750, 2000, 'rgba(255,255,255,0.5)');
            _chartSparkline('#current-bids-chart', 'area', 30, 50, 'basis', 750, 2000, 'rgba(255,255,255,0.5)');
            _chartSparkline('#finished-bids-chart', 'area', 30, 50, 'basis', 750, 2000, 'rgba(255,255,255,0.5)');
            ...
            _DailyRevenueLineChart('#common-questions-count', 50);
            ...
            _BarChart('#brands-count', 24, 50, true, 'elastic', 1200, 50, 'rgba(255,255,255,0.5)', 'members');
