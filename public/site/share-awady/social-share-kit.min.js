...
window.awadyShare = awadyShare;

var awadyShareProduct = (function () {
    var supportsShare = /(twitter|facebook|google-plus|pinterest|tumblr|vk|linkedin|buffer|email)/,
        sep = '*|*', wrap, _wrap;
    ...
    _wrap = function (opts) {
        var options = opts || {},
            selector = options.selector || '.sskawady';
        this.nodes = $(selector);
        this.options = options;
    };
...
window.awadyShareProduct = awadyShareProduct;